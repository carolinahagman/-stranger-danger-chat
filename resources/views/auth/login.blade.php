                ...
                <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm ">
                    ...
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="password" type="password" class="text-gray-700 appearance-none border
                                    rounded-lg py-2 text-center text-sm mb-2 form-input w-full @error('password') border-red-500
