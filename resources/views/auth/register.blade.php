                    ...
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="username" type="text" class="text-gray-700 appearance-none border rounded-lg
                                        py-2 text-center text-sm mb-2 w-full @error('username')  border-red-500 @enderror"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="email" type="email" class="text-gray-700 appearance-none border rounded-lg
                                            py-2 text-center text-sm mb-2 w-full @error('email') border-red-500 @enderror"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="password" type="password" class="text-gray-700 appearance-none border rounded-lg
                                        py-2 text-center text-sm mb-2 w-full @error('password') border-red-500 @enderror"
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <input id="password-confirm" type="password" class="text-gray-700 appearance-none border rounded-lg
                                py-2 text-center text-sm mb-2 w-full" name="password_confirmation" required
