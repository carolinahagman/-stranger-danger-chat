                ...
                <div class="py-5">
                    <div class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8">
                        ...
                        <form class="flex flex-wrap flex-col justify-center items-center" method="POST" action="{{ route('deleteuser', $user->id) }}">
                            @csrf
                            <input class="text-gray-700 appearance-none border rounded-lg
                                        py-2 text-center text-sm mb-2 w-full" type="text" name="username" placeholder="Enter username to confirm deletion">
                            @error('username')
